...
- Keep salary observations at job grain in `dim_jobs`, preserving raw salary text and the stored normalized USD base-pay fields. Match the site's stored-field eligibility rules; explicit periods win over stored annual inference, and dbt never re-extracts text or invents a period. Annualize with 2080 hours, 260 days, 52 weeks, or 12 months and derive the midpoint from the rounded annual bounds. Retain missing-pay jobs for coverage denominators.
